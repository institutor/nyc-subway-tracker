...
| Contextual station detail | Reopen the same station detail over the originating destination; do not turn it into another persistent destination. | `docs/product/nearby-offline/station-board-and-controls-contract.md`, Task 5 |
...
| Direction | Keep the normalized rider-facing direction and actual-destination context. Refresh may update service within that direction but may not switch to the opposite direction. | `docs/product/nearby-offline/nearby-card-and-direction-contract.md`, Task 4; `docs/product/nearby-offline/station-board-and-controls-contract.md`, Task 5 |
| Route filters | Preserve the rider's filters. A current disruption affecting a filtered route must remain visibly disclosed rather than silently hidden. | `docs/product/nearby-offline/station-board-and-controls-contract.md`, Task 5 |
...
| Scroll and reading position | Restore the same reading position within the current station, direction, map detail, or trip instruction. Insertions, removals, or refreshed values must not jump the rider to the top. | `docs/product/nearby-offline/station-board-and-controls-contract.md`, Task 5; `docs/product/nearby-offline/offline-degraded-and-reconnection-states.md`, Task 10 |
...
| §§15.1–15.5 | Station header, bottom-third controls, arrival rows, localized alerts, and honest empty/degraded states | `docs/product/nearby-offline/station-board-and-controls-contract.md`, Task 5 | Task 14 station-board and degraded-state cases |
...
| §§18.1 and 18.4 | Always-available structural content, valid schedule reference, and reconnection validity | `docs/product/nearby-offline/offline-content-and-validity-contract.md`, Task 8 | Task 14 offline validity and currency cases |
...
| §34 SPD-08 | Dark mode is default, and one-handed controls stay in the bottom third | `docs/product/nearby-offline/station-board-and-controls-contract.md`, Task 5, and `docs/product/nearby-offline/underground-visual-and-reachability-standard.md`, Task 6 | Task 14 underground interaction evidence |
