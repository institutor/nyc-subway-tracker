...
| Selected station or station complex | Keep the rider's exact selected station or complex. New location or ranking evidence may update nearby suggestions but may not silently replace the selection. | This contract, with the [saved stations and rider-controlled personalization contract](saved-station-and-personalization-contract.md), Task 11 |
...
| Saved preferences and rider controls | [Saved stations and rider-controlled personalization contract](saved-station-and-personalization-contract.md), Task 11 | Saved and contextual defaults | Owns immediate open, exact rider-intent fields, explicit ordering inputs, and station-specific controls; preferences never change operational truth. |
...
| §§26.1–26.3 | Saved context, transparent personalization, edit, pause, station reset, and delete controls | [Saved stations and rider-controlled personalization contract](saved-station-and-personalization-contract.md), Task 11 | SAVE-C01, SAVE-R01, UR-C05 consumption, and Task 14 saved-state evidence |
