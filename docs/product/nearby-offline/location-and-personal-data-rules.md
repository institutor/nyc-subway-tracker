...
The artifact header and Draft [artifact index](../artifact-index.md) row now align on §§28.1–28.3, full Task 12 provenance, the Task 13 measurement-privacy update, Privacy ownership, and six-role review. Task 8 now also routes mandatory Privacy review for its stored personal content. These metadata alignments do not approve either artifact; all same-version reviewer decisions, privacy fixtures, and lifecycle advancement remain **Pending**.
...
|---|---|---|
| [Zero-tap startup and location-permission flow](zero-tap-startup-and-permission-flow.md), Task 2 | Draft index row records §§14.1–14.2, 28.1–28.2, scenario 22, full Task 2 provenance, and the Task 12 no-prompt applying boundary. | Task 2 applies only the no-prompt boundary; Commute retains the prompt. Same-version review and observed evidence remain Pending. |
| [Saved stations and rider-controlled personalization contract](saved-station-and-personalization-contract.md), Task 11 | Artifact header and Draft index row align on §§26.1–26.3 and 28.3 plus Product, Accessibility, Data Quality, Content, and Privacy review. | This contract owns broad assurance. Same-version reviewer decisions and saved-state evidence remain Pending. |
| [Offline trip card and manual progress contract](offline-trip-card-and-progress-contract.md), Task 9 | Artifact header and Draft index row align on the full Task 9 provenance and Product, Accessibility, Data Quality, Content, and Privacy review. | Privacy must review the same fixed Task 9 version; its decision and all Task 9 evidence remain Pending. |
| [Offline content and validity contract](offline-content-and-validity-contract.md), Task 8 | Artifact header and Draft index row register Product, Accessibility, Data Quality, Content, and Privacy because the stored-content inventory includes saved stations, commutes, and trip cards. | Privacy must review the same fixed Task 8 version; routing is aligned, while the decision and all evidence remain Pending. |

This metadata alignment does not edit out-of-scope Task 8 behavior or manufacture reviewer decisions.
...
| One active card and manual progress | [Offline trip card and manual progress contract](offline-trip-card-and-progress-contract.md), Task 9 | Bound retention to one explicit active card and include it in broad deletion without redefining use. | Draft; Task 9 Privacy decision and evidence Pending |
| Stored content and reference maps | [Offline content and validity contract](offline-content-and-validity-contract.md), Task 8 | Official/structural content survives personal deletion; Privacy reviews the saved-station, commute, and trip-card inventory on the same fixed version. | Draft; Privacy decision and evidence Pending |
| Saved commute and notifications | Companion Commute workstream | Own no-prompt surfaces and explicit enablement handoff only; all prompt, control, delivery, and data decisions remain companion-owned. | Draft companion artifacts present; same-version decisions and observed evidence Pending |
...
| Observed privacy acceptance | `docs/product/nearby-offline/acceptance-evidence.md`, Task 14 | Record all five PRIV fixtures, prohibited results, fixed version, visible and assistive output, and storage/permission traces. | Draft evidence ledger present; observations and same-version approval Pending |
...
| Are the Task 2 §28.2 applying boundary, Task 11 Data Quality/§28.3 path, Task 9 Privacy path, and Task 8 Privacy path aligned? | Yes in Draft metadata; no reviewer decision or evidence is implied. | All applicable same-version reviewer decisions remain Pending |
| Does this Draft claim Gate 0 passage, any PRIV fixture, scenario 22, Task 14 evidence, Commute approval, deletion completion, optional sync enablement, or release readiness? | No. The decision remains **NO-GO — GATE 0 NOT PASSED**; public boards blocked. | Fixed evidence, all applicable reviews, companion decisions, and later release gate |
