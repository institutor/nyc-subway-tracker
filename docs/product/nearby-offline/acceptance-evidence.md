...
| 21. Useful entrance, not centroid | NEAR-S21 and CARD-UR01–CARD-UR05 | Task 3 owns practical-walk ranking | **Not run — Pending** |
...
| MAP-GEO01 — specification §§17.3–17.5 | Switch Schematic/Geographic; plan options including safer direct and fragile faster transfer | Preserve selected layer/route/station/direction/overlays; only geographic evidence supplies walking; rank validity, accessibility, risk, transfers, walk, then ETA; show a material alternative when supported | Schematic distance, centroid walk, ETA-first optimism, promised connection, invented alternative, or accessibility weight replacing hard constraint |
...
| 3 | [Station ranking and entrance rules](station-ranking-and-entrance-rules.md) | NEAR-S21, CARD-UR01–CARD-UR05, SAVE-UR05 | Eligibility-first useful-entrance ranking, useful-card target, and explicit preference boundary |
...
| 7 | [Map modes and journey behavior](map-modes-and-journey-behavior.md) | MAP-AX01, MAP-NOW01, MAP-R01, MAP-S25, MAP-GEO01, OFF-MAP01–OFF-MAP02 | Independent axes, Actual-now failure, reroute geometry, pattern boundary, spatial evidence, and stored map modes |
...
| 11 | [Saved station and personalization contract](saved-station-and-personalization-contract.md) | SAVE-C01, SAVE-R01, SAVE-UR05 | Private no-account continuity, hidden-route warning, pause/reset/delete scope, and explicit preference |
