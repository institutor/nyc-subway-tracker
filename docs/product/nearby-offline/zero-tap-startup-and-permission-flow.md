...
| Confidence and fallback | [Arrival confidence and ghost policy](../arrival-truth/arrival-confidence-and-ghost-policy.md) and [schedule fallback and currency policy](../arrival-truth/schedule-fallback-and-currency-policy.md) | Preserve state, precision, and separation; never create cached Live. | [Gate 0: **NO-GO — GATE 0 NOT PASSED**](../quality/gate-0-exit-record.md); public boards blocked; scenario evidence Pending |
